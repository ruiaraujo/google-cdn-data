...
var data = module.exports = {
  ...
  'angular-google-plus': {
    versions: ['0.1.2'],
    url: function (version) {
      return 'https://cdn.rawgit.com/mrzmyr/angular-google-plus/v' + version + '/dist/angular-google-plus.min.js';
    }
  },
  ...
  'angular-http-auth': {
    versions: ['1.2.2'],
    url: function (version) {
      return 'https://cdn.rawgit.com/witoldsz/angular-http-auth/v' + version + '/src/http-auth-interceptor.js';
    }
  },
  'ng-ckeditor': {
    versions: ['0.2.1'],
  ...
  'lodash': {
    versions: ['2.4.1'],
    url: function (version) {
      return 'https://cdnjs.cloudflare.com/ajax/libs/lodash.js/' + version + '/lodash.compat.min.js';
    }
  },
  'underscore.string': {
    versions: ['3.0.2', '2.4.0'],
    url: function (version) {
      return 'https://cdnjs.cloudflare.com/ajax/libs/underscore.string/' + version + '/underscore.string.min.js';
    }
  },
  'angular-translate': {
    versions: ['2.6.0'],
  ...
  'angular-translate-loader-partial': {
    versions: ['2.6.0'],
    url: function (version) {
      return 'https://cdn.rawgit.com/angular-translate/bower-angular-translate-loader-partial/' + version + '/angular-translate-loader-partial.min.js';
    }
  },
  ...
  'angular-data': {
    versions: ['1.5.3'],
    url: function (version) {
      return 'https://cdnjs.cloudflare.com/ajax/libs/angular-data/' + version + '/angular-data.min.js';
    }
  },
